...
// Arrow functions
let mostrarNome = (nome: string, idade: number) => {
...
let areaDoCirculo = (raio: number, PI: number = Math.PI) => {
...
function addDuasComidasFavoritas(comidas: [string, string]) {
    return comidas;
}
